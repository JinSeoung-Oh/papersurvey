...
# 설문 제출 여부 상태 초기화
if 'survey_submitted9' not in st.session_state:
    st.session_state.survey_submitted9 = False
...
st.markdown("마지막 12번 항목을 입력하실 때에는 Enter를 누르지 마시고 쭉 입력하신 뒤에 제출을 눌러주세요.")
...
if st.button("설문 제출"):
    ...
    st.session_state.survey_submitted9 = True
    st.success("응답이 저장되었습니다. 감사합니다!")
    
if st.session_state.survey_submitted9:
