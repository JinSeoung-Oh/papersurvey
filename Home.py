...
- 상황별로 제일 첫 페이지에서는 주어진 상황에 대하여 스스로 생각하시는 중재 방안을 제시해주시면 됩니다.  
  ...
  해당 페이지에서는 <span style="color:red; font-weight:bold;">중재 방안을 입력하시면 됩니다.</span>  
...
- 상황별로 두 번째 페이지에서는 LLM 베이스의 system과 상호작용을 하시게 됩니다.  
  ...
  해당 페이지에서는 <span style="color:red; font-weight:bold;">새롭게 제시된 상황을 요약해서 입력하시면 됩니다.</span>  
...
- <span style="color:red; font-weight:bold;">설문 조사 시에 생성되는 새로운 상황은 설문의 편의를 위하여 넣은 기능일 뿐 설문에서 테스트하고자 하는 시스템과는 상관 없습니다. 새롭게 생성되는 상황은 랜덤하게 감각적 원인과 비감각적 원인(ex. 의사소통 문제)이 번갈아가면서 생성이 됩니다. LLM의 특성 상 이상한 상황이 생성 될 수 있음을 먼저 알려드립니다.</span>  
